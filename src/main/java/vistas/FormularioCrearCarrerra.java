 ...
 * @author Agustin
 */
public class FormularioCrearCarrerra extends javax.swing.JFrame {
    private Facultad controler;
    private PropuestaCarrerasPanel callback;
    
    public FormularioCrearCarrerra() {
        initComponents();
        controler= new Facultad();
        setResizable(false);
        this.setLocationRelativeTo(null);
        callback=new PropuestaCarrerasPanel(this.controler);
    }
    public FormularioCrearCarrerra(Facultad controler,PropuestaCarrerasPanel callback){
        initComponents();
