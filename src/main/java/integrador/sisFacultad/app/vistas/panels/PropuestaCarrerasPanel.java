...
public class PropuestaCarrerasPanel extends javax.swing.JPanel {
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList1ValueChanged
        ...
        jTextField4.setText(Integer.toString(carrera.getId()));
        jTextField1.setText(carrera.getNombre());
        jTextArea1.setText(carrera.getDescripcion());
        jTextField2.setText(carrera.getPlan().getNombre());
        jTextField3.setText(Integer.toString(carrera.getOptativas()));
